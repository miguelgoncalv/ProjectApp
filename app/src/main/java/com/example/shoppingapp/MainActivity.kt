...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setTitle("Miguel Goncalves Silva")
        ...
        if (isTableEmpty) {
            ...
            Intent(this, SignIn::class.java).also {
                Toast.makeText(this@MainActivity, "Please log in first", Toast.LENGTH_LONG).show()
                startActivity(it)
            }
        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (selectedOption.equals("profile")) {
            ...
            Intent(this, SignIn::class.java).also {
                Toast.makeText(this@MainActivity, "Please sign in to continue", Toast.LENGTH_LONG).show()
                startActivity(it)
            }
        }
